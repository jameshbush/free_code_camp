      ...
      <div>
        <header id="header">
          <nav id="nav-bar">
            <a href="#top">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/7/7e/3D_icon.png"
                alt="brand-logo"
                id="header-img"
              />
            </a>
        ...
        <div id="hero">
          ...
          <caption>
            Video: Un Hiver à Paris (
            <a href="https://commons.wikimedia.org/wiki/File:Un_Hiver_%C3%A0_Paris_-_Vimeo.webm">WikiCommons</a>)
          </caption>
        </div>
        ...
        <main>
          ...
          <form id="form" className="section" action="https://www.freecodecamp.com/email-submit">
            <label>
              <h4 id="email-label">Subscribe to my email list</h4>
              <input type="email" name="email" size={37} id="email" placeholder="youremail@example.com" required />
            </label>
          ...
          <div id="dolphin" className="section">
            <h2>Dolphin...</h2>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
